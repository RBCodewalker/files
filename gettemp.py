...
parser = argparse.ArgumentParser(description="Get temperature data from cube4envsec.org/rasdaman.")
...
coverage_id_param = "COVERAGEID=temperature_new"
ansi_subset = "SUBSET=ansi(\"2022-11-24T00:00:00.000Z\")"
